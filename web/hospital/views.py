...
def home_view(request):
    ...
    doctors = models.Doctor.objects.all()[:3]
    return render(request, "hospital/index.html", {"doctors": doctors})


def trusted_doctors(request):
    # Fetch the first three doctors from the database
    return render(request, "hospital/trusted_doctors.html")
